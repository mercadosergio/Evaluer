...
<body>
    ...
    <div class="fondo">
        <div class="container-title">
            ...
            <p style="text-align: left; font-size: 28px;">Campus de seguimiento e investigación. Interactua con entregas de proyectos de grado, evaluaciones, comentarios y notas.</p><br>
        </div>
