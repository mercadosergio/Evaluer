        ...
        <div id="panel-propuesta" class="contenido_propuesta">
            ...
            <div class="contenido">
                ...
                <div>
                    ...
                    <input class="linea" readonly id="linea" type="text" value="">
                </div>
                <div>
                    <label class="lbl-programa">Programa:</label>
                    <input class="programa" readonly id="program" type="text">
                </div>
                <div>
                    <label class="lbl-semestre">Semestre:</label>
                    <input class="semestre" readonly id="semestre" type="text">
                </div>
                <div>
                    <label class="lbl-integrantes">Número de integrantes:</label>
                    <input class="integrantes" readonly id="num" class="texto-numero" type="text">
                </div>
                <div>
                    <label class="lbl-tutor">Nombre del asesor:</label>
                    <input class="tutor" readonly id="tutor" type="text">
                </div>
                <div>
                    <label class="lbl-lider">Nombre del lider:</label>
                    <input class="lider" readonly id="lid" type="text">
                </div>
                <div></div>
                <div></div>
                <div></div>
                ...
                <input class="equipo" style="width: 700px;" readonly id="n_integrantes" type="text">
                <label class="lbl-fecha">Fecha y hora:</label>
                <input class="fecha" type="text" id="time">
