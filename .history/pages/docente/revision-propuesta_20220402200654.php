    ...
    <div class="modal">
        <div id="panel-propuesta" class="contenido_propuesta">
            ...
            <div class="contenido">
                ...
                <label>Programa:</label><input readonly id="program" type="text">
                <label>Semestre:</label><input readonly id="semestre" type="text">

                <label>Número de integrantes:</label><input readonly id="num" class="texto-numero" type="text">
                <label>Nombre del tutor:</label><input readonly id="tutor" type="text">
                <label>Nombre del lider:</label><input readonly id="lid" type="text">
                ...
                <label>Nombre de los integrantes:</label><input style="width: 700px;" readonly id="n_integrantes" type="text">
