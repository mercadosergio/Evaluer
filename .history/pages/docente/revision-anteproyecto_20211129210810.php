                        ...
                        <form action="../../controller/calificar-anteproyecto.php" method="POST">
                            ...
                            <td>
                                <ul class="o" style="color: black; background: white;">
                                    <li>
                                        <label for="#radio_d" style="width: 100px; height: 10px; background: red;">dddddd<?php echo $filas['observaciones']; ?></label>
                                        <input id="radio_d" type="radio">
                                        <ul class="texto_o">
                                            <li><textarea name="observacion" id="" cols="30" rows="10"></textarea></li>
                                        </ul>
                                    </li>
                                </ul>
                            </td>
