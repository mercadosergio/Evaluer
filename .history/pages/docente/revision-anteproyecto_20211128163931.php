    ...
    <section class="anteproyecto">
        ...
        <div class="contenedor-titulo">
            <table id="tabla" class="ant">
                ...
                <?php
                $mostrar_a_by_fecha = "SELECT id,nombre,documento,comentarios,programa,fecha,estado, FROM anteproyecto a JOIN docente d ON a.programa_id = d.programa_id ORDER BY fecha";
                $result = mysqli_query($conexion, $mostrar_a_by_fecha);
