    ...
    <section class="anteproyecto">
        ...
        <div class="contenedor-titulo">
            <table id="tabla" class="ent">
                ...
                <?php
                $mostrar_by_fecha = "SELECT * FROM proyecto_grado a JOIN docente d ON a.programa_id = d.programa_id ORDER BY fecha";
                ...
                ?>
                    <tr>
                        <form action="../../controller/calificar-anteproyecto.php" method="POST">
                            ...
                            <td>
                                <input name="getIdProyecto" type="text" hidden value="<?php echo $filas['id'] ?>">
