    ...
    <div class="modal">
        <div id="panel-propuesta" class="contenido_propuesta">
            ...
            <div class="contenido">
                ...
                <center>
                    <input type="text" readonly id="titulo_id">
                </center>

                <table class="tabla2">
                    <tr>
                        <td colspan="3"><label>Linea de investigación:</label><input readonly id="linea" type="text" value=""></td>

                    </tr>
                    <tr>
                        <td colspan="2"><label>Programa:</label><input readonly id="program" type="text"></td>
                        <td><label>Semestre:</label><input readonly id="semestre" type="text"></td>
                    </tr>
                    <tr>
                        <td><label>Número de integrantes:</label><input readonly id="num" class="texto-numero" type="text"></td>
                        <td><label>Nombre del tutor:</label><input readonly id="tutor" type="text"></td>
                        <td><label>Nombre del lider:</label><input readonly id="lid" type="text"></td>
                    </tr>
                </table>
                ...
                <table class="tabla3">
                    <td colspan="3"><label>Nombre de los integrantes:</label><input style="width: 700px;" readonly id="n_integrantes" type="text"></td>
                </table>
                <table class="fecha_entrega">
                    <tr>
                        <td>
                            <label class="fecha">Fecha y hora:</label><input type="text" id="time">
                        </td>
                    </tr>
                </table>
            </div>
