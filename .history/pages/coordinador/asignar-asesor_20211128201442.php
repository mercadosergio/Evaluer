...
<body>
    ...
    <table class="tabla_asesor" border="2">
        <thead>
            <tr>
                <th>Titulo</th>
                <th>Integrantes</th>
        ...
        ?>
            <tr>
                ...
                <form action="../../controller/asignar-docente.php" method="POST">
                    <td>
                        <select name="tutor[]" class="programa-s">
                    ...
                    <td>
                        ...
                        <input name="asignar" value="Guardar" type="submit">
                </form>
                </td>
            </tr>
        <?php
