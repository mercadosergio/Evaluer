    ...
    <section class="seccion-inscripcion">
        ...
        <form method="POST" id="envio">
            <div class="grid-form">
                ...
                <h3 class="subtitulo">A continuación diligencie los datos para la inscripción de su proyecto</h3>

                <p class="info">
                    Diligencie la información correspondiente a su propuesta de grado, con los datos requeridos para evaluar un proyecto de grado.
                </p>
