        ...
        <form method="POST" id="envio">
            <div class="formulario">
                ...
                <?php
                    ...
                    <label>Linea de investigación:</label><input <?php echo (time() < $tiempo['0']) ? "disabled" : ''; ?> type="text" class="campotexto" name="linea">
               
                  
        <label>Número de integrantes:</label><input <?php echo (time() < $tiempo['0']) ? "disabled" : ''; ?> type="number" max="3" min="1" class="camponumero" name="integrantes">
                        <td><label>Nombre del asesor:</label><input disabled <?php echo (time() < $tiempo['0']) ? "disabled" : ''; ?> type="text" class="campotexto" name="tutor">
                        <td style="margin-left: 30px;"><label>Nombre del lider:</label><input <?php echo (time() < $tiempo['0']) ? "disabled" : ''; ?> type="text" class="campotexto" name="lider">
