...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="fecha">
                        <a href="fecha-entrega.php" class="nav-link"><span data-hover="Fechas de entrega">Fechas de
                                entrega</span></a>
                    </li>
                </ul>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <?php
            ...
            // $fecha_envio = $conexion->query("SELECT * FROM anteproyecto WHERE usuario= '$variable_sesion");
            // $myresult = mysqli_fetch_array($fecha_envio);
            // if ($fecha_actual == $fecha_envio['fecha']) {
            // }
            ?>
            <div class="detalles">
