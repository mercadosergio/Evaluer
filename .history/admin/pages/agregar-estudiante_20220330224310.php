...
<body>
    ...
    <div class="form-add-student">
        <input type="text" name="nombres" class="campo-nombre">
        <input type="text" name="p_apellido" class="campo-primer-apellido">
        <input type="text" name="s_apellido" class="campo-segundo-apellido">
        <input type="text" name="cedula" class="campo-cedula">
        ...
        <input type="text" name="semestre" class="cammpo-semestre">
        <input type="text" name="email" class="campo-email">
    </div>
