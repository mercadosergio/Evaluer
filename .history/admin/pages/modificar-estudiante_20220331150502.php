        ...
        <form method="POST">
            <div class="formulario-edit-user">
                ...
                <div class="cont-campos">
                    <label>Nombre:</label><input type="text" class="campotexto" name="nombre" value="<?= $nombre ?>">
                    <label>Primer apellido:</label><input type="text" class="campotexto" name="p_apellido" value="<?= $p_apellido ?>">
                    <label>Segundo apellido:</label><input type="text" class="campotexto" name="s_apellido" value="<?= $s_apellido ?>">
