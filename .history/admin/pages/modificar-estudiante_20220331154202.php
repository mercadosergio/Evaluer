        ...
        <form method="POST">
            <div class="formulario-edit-user">
                ...
                <div class="cont-campos">
                    ...
                    <label>Documento de identidad:</label><input type="text" class="cedula" name="cedula" value="<?= $id_n ?>">
                    ...
                    <label class="lbl-semestre">Semestre:</label><input type="number" max="9" min="6" class="camponumero" name="semestre" value="<?= $semestre ?>">
