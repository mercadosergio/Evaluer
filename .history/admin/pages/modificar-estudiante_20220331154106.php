        ...
        <form method="POST">
            <div class="formulario-edit-user">
                ...
                <div class="cont-campos">
                    <label class="lbl-nombre">Nombre:</label><input type="text" class="campotexto" name="nombre" value="<?= $nombre ?>">
                    <label class="lbl-p-apellido">Primer apellido:</label><input type="text" class="campotexto" name="p_apellido" value="<?= $p_apellido ?>">
                    <label class="lbl-s-apellido">Segundo apellido:</label><input type="text" class="campotexto" name="s_apellido" value="<?= $s_apellido ?>">
               
                    <label>Documento de identidad:</label><input type="text" class="campotexto" name="cedula" value="<?= $id_n ?>">
                    ...
                    <label>Semestre:</label><input type="number" max="9" min="6" class="camponumero" name="semestre" value="<?= $semestre ?>">
