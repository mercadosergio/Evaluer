...
if (isset($_POST['modificar-docente'])) {
    ...
    for ($i = 0; $i < count($programa_id); $i++) {
        $update_e = $conexion->query("UPDATE docente SET nombre='$nombre', p_apellido='$p_apellido', s_apellido='$s_apellido', cedula='$id_n',
...
if (isset($_POST['modificar-coordinador'])) {
    ...
    $update_e = $conexion->query("UPDATE coordinador SET nombre='$nombre', p_apellido='$p_apellido', s_apellido='$s_apellido', cedula='$id_n',
        programa_id='$programa_id[$i]',usuario='$id_n' WHERE id = '$id'");
