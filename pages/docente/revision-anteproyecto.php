                ...
                <tbody id="contenido_tabla">
                    ...
                    <tr>
                        <form action="../../controller/evaluate-anteproyecto.php" method="POST">
                            ...
                            <td><input type="text" name="estado" value="<?php echo $filas['estado'] ?>"
                            ...
                            <td>
                                ...
                                <ul class="o" style="color: black; background: white;">
                                    <li>
                                        ...
                                        <ul class="texto_o">
                                            <li>
                                                <textarea placeholder="Escriba aquí" name="observacion" id="" cols="30"
                                                    rows="10"><?php echo $filas['observaciones']; ?>
                                                </textarea>

                                            </li>
                                            <input name="getIdAnteproyecto" type="text" hidden
                                                value="<?php echo $filas['0'] ?>">
